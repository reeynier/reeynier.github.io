---
layout: post
title: "Bag Of Tokens Problem"
categories: [ Algorithm, Data Structure ]
tags: [ Array, Two Pointers, Greedy, Sorting ]
similar: [ Two Pointers ]
featured: false
hidden: false
excerpt: LeetCode 948. You have an initial power of power, an initial score of 0, and a bag of tokens where tokens[i] is the value of the i^th token (0-indexed).
