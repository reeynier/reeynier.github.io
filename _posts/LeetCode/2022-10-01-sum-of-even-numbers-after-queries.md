---
layout: post
title: "Sum Of Even Numbers After Queries Problem"
categories: [ Algorithm, Data Structure ]
tags: [ Array ]
similar: [ Array ]
featured: false
hidden: false
excerpt: LeetCode 985. You are given an integer array nums and an array queries where queries[i] = [val_i, index_i].
